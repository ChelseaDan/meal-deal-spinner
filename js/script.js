...
(function () {
  ...
  SlotMachine.prototype.beforeRun = function () {
    if (completed) {
      ...
      completed = false;
      var result = [];
      result[0] = this.options.names[0][
        Math.floor(random(this.options.names[0].length))
      ];
      result[1] = this.options.names[1][
        Math.floor(random(this.options.names[1].length))
      ];
      result[2] = this.options.names[2][
        Math.floor(random(this.options.names[2].length))
      ];
